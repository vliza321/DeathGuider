...
public class ProjectileInWeapon : MonoBehaviour
{
    ...
    private GameObject attactDirection;
    [SerializeField]
    private Vector3 worldPosition;
    [SerializeField]
    private float playerToObjAngle;
    private float PI;
    public GameObject AttactDirection
    {
    ...
    public void Execute()
    {
        ...
        cashingVector3.x = MathF.Abs(this.transform.localScale.x); cashingVector3.y = MathF.Abs(this.transform.localScale.y); cashingVector3.z = MathF.Abs(this.transform.localScale.z);
        this.transform.localScale = cashingVector3;

        grandParentPos = baseParent.transform.parent.transform.position ;
        ...
        cashingVector3.x = 0; cashingVector3.y = 0; cashingVector3.z = playerToObjAngle;
